# Hi there, I'm Rahma Ezzat 👋

### 🚀 Backend Developer | MEAN Stack Specialist | IT Infrastructure Enthusiast

I am a 2024 Computer Science graduate with a passion for building secure, scalable, and high-performance backend systems. My unique edge comes from bridging the gap between robust **IT Infrastructure** and modern **Software Engineering**.
...
- **[Real-Time Messaging App (Saraha)](https://github.com/rahmaelnaqeb-ctrl/saraha_app.git):** - Developed a high-concurrency messaging platform handling 50+ concurrent socket connections using Node.js and Socket.io.
  - Implemented secure JWT authentication and optimized MongoDB queries to ensure sub-100ms message delivery.
  - Enhanced system performance by 20% through efficient memory management.
...
### 📫 Let's Connect!
- 💼 [LinkedIn Profile](https://www.linkedin.com/in/rahma-ezzat-yousef)
- 📧 [rahma.elnaqeb@gmail.com](mailto:rahma.elnaqeb@gmail.com)
- 📍 Egypt

*"Designing systems that are as secure as they are smart."*
